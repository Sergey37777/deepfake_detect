...
parser.add_argument("--input", type=str, help="Path with images.", required=True)
arg = parser.parse_args()


video_path = arg.input

filenames = glob.glob(video_path + "*.mp4")
filenames.sort()
...
print(submission.head(len(filenames)))
